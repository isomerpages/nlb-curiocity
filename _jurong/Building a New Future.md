...
The urban design approach to create a distinctive skyline for the Jurong Regional Centre to signify it as a gateway to the Western region is the massing of building around Jurong East MRT station at close proximity. At the time of the planning, it was envisioned that the MRT station would be surrounded by 4 tower blocks at its core, and served by a one-way inner ring road system, an integrated pedestrian system and a bus interchange.
