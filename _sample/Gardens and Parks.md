...
| To enable the establishment of the botanic garden, Raffles made a personal donation of 1,000 dollars and allocated a 19-hectare site on the eastern slope of Fort Canning Hill as shown in this 1828 "Plan of the Town of Singapore". Encompassing the "Government Garden" that he created, the grounds of the botanic garden was bounded by Selegie Road to the east, Hill Street to the south and "any extent of ground required" to the north. (Image Credit: [Courtesy of the British Library](https://commons.wikimedia.org/wiki/File:Nutmeg_Tree_-_40_drawings_of_plants_at_Bencoolen,_Sumatra_(c.1824)_-_BL_NHD_48-23.jpg)|
