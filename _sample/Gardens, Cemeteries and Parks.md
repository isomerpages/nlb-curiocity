...
| In 2019, a new park called Jubilee Park was created within the grounds of Fort Canning Park. The park is situated at the same site as King George V Park. It is also modelled after the latter as a family-friendly leisure space, with giant seesaws, slides and climbing frames made out of natural logs. (Image Credit: [Photo by (CC BY-NC-SA 2.0)](https://flic.kr/p/nvLmVa){:target="_blank"}) |
